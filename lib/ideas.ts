...
Begin now.`,
  ...
  },
  {
    ...
    year: "2018",
    essay: [
      "In the 2026 second edition of Rewired, McKinsey’s playbook on winning with technology and AI, the firm reports a number from its State of AI survey: 39 percent of companies said they didn’t know the EBIT impact of their AI, because they had never worked out how to track it. Another 22 percent said the impact was nothing. What nearly every company can tell you is how busy its AI has been: pilots launched, copilot seats, agent runs, hours of autonomous work. Activity, reported as results.",
      "And agents make this worse, not better: an agent will hit whatever target you give it. Target activity and you get activity, endlessly, and nothing else.",
      "The fix is old, simple, and still running. Measure What Matters is John Doerr’s 2018 book on OKRs: objectives and key results. Andy Grove built the system at Intel in the 1970s, and Doerr, who learned it there as a young manager, took it to Google in 1999 when the whole company was about thirty people. Google still runs on it today. Very few management ideas last fifty years. This one has because it fits on a page.",
      "Here is the whole system.",
      "An OBJECTIVE is the outcome you’re after, in plain words. Concrete, significant, a little ambitious. “Become AI-first” doesn’t qualify. “Cut claims settlement time in half without hurting accuracy” does.",
      "KEY RESULTS are the numbers that prove you got there, about three per objective. Two rules carry all the weight:",
      {
        list: [
          "No number, no key result. At quarter’s end you either hit it or you didn’t; there’s no gray area to hide in.",
          "The number measures output, not activity. Counting how busy you are is what Doerr’s book calls the activity trap.",
        ],
      },
      "Then the operating habits that keep it honest:",
      {
        list: [
          "Quarterly, not annual. Short enough to correct course while it still matters.",
          "Public. Everyone’s OKRs visible to everyone, the CEO’s included.",
          "Off compensation, by design, so people can commit to hard targets without betting their bonus on them.",
          "Graded 0 to 1.0 at the end. On a real stretch goal, 0.7 is a win, and a clean 1.0 means you aimed too low.",
        ],
      },
      "That’s it. That’s the system Google scaled on.",
      "And it is not a tech-company trick. Rewired’s best example is a copper miner. The way Freeport-McMoRan had always gotten more copper was to build a new mine or a new plant: enormous capital, years of permitting. In 2018, leadership set a different goal: a new facility’s worth of extra copper without building one. They pointed AI at the mills they already had, starting with a single pilot at a mine in Arizona, and the number they tracked was not models deployed or pilots run. It was pounds of copper. The program scaled across their biggest operations, lifted production 10 to 15 percent with no major new capital, and paid back the initial investment in under a year. Two hundred million extra pounds of copper per year. That is a key result.",
      "Every AI program has its pound of copper: the output number that proves it worked. Most dashboards never name it.",
      "One warning before you write yours. I’m in the middle of Paul Cheek’s new book No One Works Here, and it names something every agent owner has felt: the reliability tax. When an agent first takes on a job, things get slower before they get faster, because you’re auditing everything it produces until you can trust it. Latency spikes before it collapses. Set your key results with that curve in mind: a workflow still earning trust gets a modest target, and a workflow that has earned it gets the ambitious one. More on that book soon.",
      "This week: write the three numbers that would prove your top AI initiative worked. Numbers the business feels: cycle time cut, hours redeployed, revenue added. If you can’t write them, that’s the finding.",
      "The prompt below does this with you: paste in your AI goals and it separates real key results from activity dressed up in numbers.",
    ],
...
Begin now.`,
    ...
    headline: "Most companies cannot tell you what their AI program has returned. Not won't. Can't.",
    bookNote:
