...
Begin now.`,
  ...
  },
  {
    ...
    essay: [
      ...
      "Rockets, it turned out, are used once and thrown away. One payload, one rocket. Make them reusable and the cost collapses, but reuse means surviving reentry, the fall to Earth at eighteen thousand miles an hour through a furnace hot enough to melt the ship. NASA’s shuttle fought that furnace with thirty-five thousand heat tiles, each inspected and refitted by hand after every flight. It was cheaper to throw the rocket away.",
      "So Musk refused the problem. Fuel, he realized, is cheaper than vehicles, so why survive reentry at all? A Falcon 9 flips over, fires its engines to slow the fall, and lands upright on its tail. Within a few years it was reaching orbit twenty-three times cheaper than the shuttle.",
